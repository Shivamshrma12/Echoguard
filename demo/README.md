...
- **Duration:** 4 minutes 56 seconds (under 5 minutes)
- **Content:**
  ...
  3. Real-time automatic voice barge-in (0.13ms software audio buffer flush).
  4. Monotonic Generation Fencing (`GEN-N` invalidated, `GEN-N+1` created).
  5. Stale delayed result rejection (HTTP 410 / `FENCED_REJECTED` with zero stale spoken leaks).
